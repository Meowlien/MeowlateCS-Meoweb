...
namespace Meoweb.Controllers.Sample {
    ...
    // For 資料模型
    public partial class Sample_PostController : WebApiTemplate
        <Sample_PostController.RequestDataModel, Sample_PostController.ResponseDataModel> {
...
#endif
    public partial class Sample_PostController {
    ...
    public partial class Sample_PostController {
        ...
        public Sample_PostController(ILogger<Sample_PostController> logger, SampleDbCtx dbCtx)
    ...
    public partial class Sample_PostController {
        ...
        protected override bool ProcessData() {
            ...
            try {
                // 呼叫資料庫
                if(SampleDbCtx.GetDataByAny(new SampleDataModel.Data.Linq() {
                    // 資料庫查詢所需參數
                    Data_A = RequestData.Data_A,
                    Data_B = RequestData.Data_B,

                // 查詢成功
                }, out SampleDataModel.Data.Result? data) == true) {
